...
export default function SupplierCustomerInsights() {
  ...
  const avgRating = mockCustomerData.filter(c => c.rating > 0).reduce((sum, c) => sum + c.rating, 0) / mockCustomerData.filter(c => c.rating > 0).length
  const avgPaymentDays = mockCustomerData.reduce((sum, c) => sum + c.paymentDays, 0) / totalCustomers
  ...
  const getTypeText = (type: CustomerData['type']) => {
    switch (type) {
      case 'premium': return '頂級客戶'
      case 'standard': return '標準客戶'
      case 'new': return '新客戶'
    }
  }
  ...
  const handleCustomerSelect = React.useCallback((customer: CustomerData) => {
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-3 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-blue-600 font-medium">總客戶數</p>
              ...
              <div className="p-3 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-purple-600 font-medium">頂級客戶</p>
              ...
              <div className="p-3 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-yellow-600 font-medium">平均評分</p>
              ...
              <div className="p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-green-600 font-medium">平均付款天數</p>
                    <p className="text-2xl font-bold text-green-700">{Math.round(avgPaymentDays)}</p>
                  </div>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <div className={cn(
                        ...
                        {customer.growthRate >= 0 ? <TrendingUp className="h-3 w-3" /> : <TrendingDown className="h-3 w-3" />}
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="font-medium ml-1">{formatDate(customer.lastOrderDate)}</span>
                    </div>
                    <div>
                      <span className="text-gray-600">付款天數:</span>
                      <span className="font-medium ml-1">{customer.paymentDays} 天</span>
                    </div>
                  </div>

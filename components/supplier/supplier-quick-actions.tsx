...
import { AccessibleFormField, AccessibleSelect, AccessibleTextarea } from '@/components/ui/accessible-form'
...
function QuickAction({ 
  ...
  return (
    <Button
      variant="ghost"
      className={`h-auto p-4 flex flex-col items-center text-center space-y-3 border-2 transition-all duration-200 relative ${getVariantStyles()}`}
      onClick={onClick}
      disabled={disabled}
...
export default function SupplierQuickActions() {
  ...
  const handleScheduleDelivery = React.useCallback(() => {
    ...
    setDeliveryData({ delivery_date: '', time_slot: '', special_instructions: '', vehicle_type: 'standard' })
  }, [announceSuccess])
      ...
      <Card>
        <CardHeader>
          <CardTitle id="supplier-quick-actions-title" className="flex items-center space-x-2">
            <span>供應商快速操作</span>
            <div className="h-2 w-2 bg-blue-600 rounded-full" aria-hidden="true" />
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-medium text-blue-900 mb-2">發票上傳提醒：</h4>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h4 className="font-medium text-green-900 mb-2">庫存更新功能：</h4>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h4 className="font-medium text-yellow-900 mb-2">配送注意事項：</h4>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <h4 className="font-medium text-purple-900 mb-2">溝通功能：</h4>

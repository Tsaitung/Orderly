...
export default function CustomerList({ searchParams }: CustomerListProps) {
  ...
  if (!organizationId) {
    return (
      <Card className="p-6">
        <div className="text-center text-gray-500">載入組織資訊中...</div>
      </Card>
    )
  }
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        {selectedCustomers.length > 0 && (
          <div className="flex items-center space-x-3">
            <span className="text-sm text-gray-600">已選取 {selectedCustomers.length} 位</span>
            <Button
              variant="outline"
              size="sm"
      ...
      <div className="mb-4 flex items-center space-x-4 border-b pb-4">
        <label className="flex cursor-pointer items-center space-x-2">
          <input
            ...
            onChange={
              selectedCustomers.length === customers.length ? clearSelection : selectAllCustomers
            }
        ...
        <span className="text-sm text-gray-500">
          顯示{' '}
          {pagination
            ? `${(pagination.page - 1) * pagination.page_size + 1}-${Math.min(pagination.page * pagination.page_size, pagination.total_count)}`
            : '0'}{' '}
          位，共 {pagination?.total_count || 0} 位客戶
        </span>
      ...
      <div className="space-y-4">
        ...
        {!loading && customers.length === 0 && (
          <div className="py-12 text-center">
            ...
            <p className="mb-4 text-gray-500">尚無客戶資料</p>
              ...
              {isExpanded && (
                <div className="border-t bg-gray-50 p-4">
                  <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    {/* 聯絡資訊 */}
                    <div>
                      <h4 className="mb-3 font-medium text-gray-900">聯絡資訊</h4>
                      <div className="space-y-2">
                        ...
                        <div className="flex items-start space-x-2">
                          ...
                          <span className="text-sm">
                            {customer.delivery_address || '未設定配送地址'}
                          </span>
                        </div>
                        <div className="flex items-center space-x-2">
                    ...
                    {/* 關鍵指標與偏好設定 */}
                    <div>
                      <h4 className="mb-3 font-medium text-gray-900">客戶偏好</h4>
                      <div className="space-y-3">
                        ...
                        <div className="rounded border bg-white p-2">
                          ...
                          <div className="text-sm">
                            頻率: {customer.delivery_frequency || '未設定'}
                            <br />
                    ...
                    {/* 備註與特殊要求 */}
                    <div>
                      <h4 className="mb-3 font-medium text-gray-900">客戶備註</h4>
                      <div className="space-y-3">
                        <div className="rounded border bg-white p-3">
                        ...
                        {customer.last_order_date && (
                          <div>
                            <h5 className="mb-2 text-sm font-medium text-gray-700">最近訂單</h5>
                            <div className="rounded border bg-white p-2">
                              <div className="text-sm">
                  ...
                  <div className="mt-6 flex items-center justify-between border-t pt-4">
                    <div className="text-sm text-gray-500">
                      最後更新:{' '}
                      {customer.updated_at ? formatDate(new Date(customer.updated_at)) : '未知'}
                    </div>
                    <div className="flex space-x-2">
                      ...
                      {(customer.status === 'at_risk' ||
                        customer.relationship_type === 'at_risk') && (
                        <Button
                          size="sm"
      ...
      {pagination && pagination.total_pages > 1 && (
        <div className="mt-6 flex items-center justify-between border-t pt-4">
          <div className="text-sm text-gray-500">
            ...
            {Math.min(pagination.page * pagination.page_size, pagination.total_count)} 位，共{' '}
            {pagination.total_count} 位客戶
          </div>
          <div className="flex items-center space-x-2">
            <Button
              variant="outline"

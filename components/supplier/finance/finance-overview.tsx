  ...
  return (
    <div className="space-y-6">
      ...
      {urgentItems.some(item => item.count > 0) && (
        <Card className="border-orange-200 bg-orange-50 p-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h3 className="mb-3 font-medium text-orange-900">財務提醒</h3>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {urgentItems
                  .filter(item => item.count > 0)
                  .map(item => (
                    <div key={item.id} className="rounded-lg border border-orange-200 bg-white p-3">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="p-6">
          <h3 className="mb-4 font-medium text-gray-900">收款進度</h3>
          <div className="space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-blue-600">
                {formatCurrency(financeData.collected)}
              </span>
            </div>
        ...
        <Card className="p-6">
          <h3 className="mb-4 font-medium text-gray-900">帳齡分布</h3>
          <div className="space-y-3">
        ...
        <Card className="p-6">
          <h3 className="mb-4 font-medium text-gray-900">本月發票</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between">

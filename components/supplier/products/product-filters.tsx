...
import { Search, Filter, SortAsc, Grid, List, Download, RefreshCw } from 'lucide-react'
...
export default function ProductFilters({ searchParams }: ProductFiltersProps) {
  ...
  const getActiveFilterCount = () => {
    return Object.values(activeFilters).filter(value => value !== 'all' && value !== 'name-asc')
      .length
  }
    ...
    <div className="space-y-4">
      ...
      <Card className="p-4">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          {/* 產品類別 */}
          <div>
            <h4 className="mb-3 text-sm font-medium text-gray-700">產品類別</h4>
          ...
          {/* 庫存狀態 */}
          <div>
            <h4 className="mb-3 text-sm font-medium text-gray-700">庫存狀態</h4>
          ...
          {/* 價格區間 */}
          <div>
            <h4 className="mb-3 text-sm font-medium text-gray-700">價格區間</h4>
            <div className="space-y-2">
      ...
      {getActiveFilterCount() > 0 && (
        <Card className="border-blue-200 bg-blue-50 p-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium text-blue-700">顯示 1,247 項產品中的 892 項</span>
          </div>
        </Card>
      )}
    </div>

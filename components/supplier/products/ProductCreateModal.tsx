...
const PACKAGE_TYPES = [
  '紙箱', '塑膠袋', '真空包裝', '保溫袋', '木箱', '鐵罐', '玻璃瓶', '塑膠盒', '其他'
];
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {PRICE_TYPES.map(priceType => (
                  ...
                  >
                    <h4 className="font-medium text-sm">{priceType.label}</h4>
                    <p className="text-xs text-gray-600 mt-1">{priceType.description}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleFieldChange('packaging_info.units_per_package', parseInt(e.target.value) || 1)}
                  placeholder="1"
                  min="1"
                  className={errors['packaging_info.units_per_package'] ? 'border-red-500' : ''}
                />
                {errors['packaging_info.units_per_package'] && (
                  <p className="text-sm text-red-600 mt-1">{errors['packaging_info.units_per_package']}</p>
                )}
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleFieldChange('packaging_info.package_weight_kg', e.target.value ? parseFloat(e.target.value) : undefined)}
                  placeholder="選填"
                  min="0"
                  step="0.1"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onChange={(checked) => handleFieldChange('packaging_info.refrigeration_required', checked)}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleFieldChange('packaging_info.shelf_life_days', e.target.value ? parseInt(e.target.value) : undefined)}
                  placeholder="選填"
                  min="1"
                />
              </div>

...
import { Package, TrendingUp, AlertTriangle, DollarSign, ShoppingCart, Star } from 'lucide-react'
...
export default function ProductStats() {
  return (
    <div className="space-y-6">
      ...
      {/* 快速統計 */}
      <Card className="p-4">
        <h3 className="mb-4 font-medium text-gray-900">快速統計</h3>
          ...
          {quickStats.map((stat, index) => (
            <div key={index} className="flex items-center space-x-3 rounded-lg bg-gray-50 p-3">
              ...
              <div>
                ...
                <div className="text-xs font-medium text-green-600">{stat.trend}</div>
              </div>
            </div>
          ))}
        </div>

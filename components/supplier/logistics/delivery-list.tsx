...
export default function DeliveryList({ searchParams }: DeliveryListProps) {
  ...
  return (
    <Card className="p-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        {selectedDeliveries.length > 0 && (
          <div className="flex items-center space-x-3">
            <span className="text-sm text-gray-600">已選取 {selectedDeliveries.length} 筆</span>
      ...
      <div className="mb-4 flex items-center space-x-4 border-b pb-4">
        <label className="flex cursor-pointer items-center space-x-2">
          <input
            ...
            onChange={
              selectedDeliveries.length === mockDeliveries.length
                ? clearSelection
                : selectAllDeliveries
            }
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="grid flex-1 grid-cols-1 items-center gap-4 md:grid-cols-6">
                    <div className="md:col-span-2">
                      ...
                      <div className="text-sm text-gray-500">訂單: {delivery.orderId}</div>
                    ...
                    <div>
                      ...
                      <div className="max-w-24 truncate text-xs text-gray-400">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500">{delivery.items.length} 項商品</div>
                      {delivery.temperature && (
                        <div className="text-xs text-blue-600">{delivery.temperature}°C</div>
                      )}
                    </div>
              ...
              {isExpanded && (
                <div className="border-t bg-gray-50 p-4">
                  <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    {/* 配送詳情 */}
                    <div>
                      <h4 className="mb-3 font-medium text-gray-900">配送詳情</h4>
                      <div className="space-y-3">
                        <div className="rounded border bg-white p-3">
                          <div className="mb-2 text-sm font-medium text-gray-700">收件地址</div>
                        ...
                        <div className="rounded border bg-white p-3">
                          <div className="mb-2 text-sm font-medium text-gray-700">配送商品</div>
                        ...
                        {/* 聯絡司機 */}
                        <div className="rounded border bg-white p-3">
                          <div className="mb-2 text-sm font-medium text-gray-700">司機資訊</div>
                    ...
                    {/* 追蹤記錄 */}
                    <div>
                      <h4 className="mb-3 font-medium text-gray-900">追蹤記錄</h4>
                      <div className="space-y-3">
                        <div className="rounded border bg-white p-3">
                          <div className="mb-2 text-sm font-medium text-gray-700">路線資訊</div>
                        ...
                        <div className="max-h-48 overflow-y-auto rounded border bg-white p-3">
                          <div className="mb-2 text-sm font-medium text-gray-700">配送歷程</div>
                          <div className="space-y-2">
                  ...
                  <div className="mt-6 flex items-center justify-between border-t pt-4">
                    <div className="text-sm text-gray-500">
                      ...
                      {delivery.tracking && delivery.tracking.length > 0
                        ? formatDate(delivery.tracking[delivery.tracking.length - 1]!.time)
                        : '無資料'}
                    </div>
      ...
      {/* 分頁控制 */}
      <div className="mt-6 flex items-center justify-between border-t pt-4">
        <div className="text-sm text-gray-500">顯示第 1-4 筆，共 156 筆配送</div>
        <div className="flex space-x-2">

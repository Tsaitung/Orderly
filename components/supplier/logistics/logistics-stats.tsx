...
export default function LogisticsStats() {
  return (
    <div className="space-y-6">
      ...
      {/* 詳細指標 */}
      <Card className="p-6">
        <h3 className="font-medium text-gray-900 mb-4">營運指標</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* 配送狀態分布 */}
        <Card className="p-6">
          <h3 className="font-medium text-gray-900 mb-4">配送狀態分布</h3>
        ...
        {/* 地區配送統計 */}
        <Card className="p-6">
          <h3 className="font-medium text-gray-900 mb-4">地區配送統計</h3>
          <div className="space-y-3">
            ...
            {regionalStats.map((region, index) => (
              <div key={index} className="grid grid-cols-4 gap-2 text-sm">
                ...
                <span className="text-center text-blue-600 font-medium">{region.deliveries}</span>
                <span className={`text-center font-medium ${
                  region.onTime >= 95 ? 'text-green-600' : 
                  region.onTime >= 90 ? 'text-orange-600' : 'text-red-600'
                }`}>
                  {region.onTime}%
                </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="p-6">
          <h3 className="font-medium text-gray-900 mb-4">實時警報</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-red-50 border border-red-200 rounded">
              ...
              <Badge variant="destructive" size="sm">2 筆</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded">
              ...
              <Badge variant="warning" size="sm">5 筆</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded">
              ...
              <Badge variant="info" size="sm">1 台</Badge>
            </div>
          </div>
        </Card>

        <Card className="p-6">
          <h3 className="font-medium text-gray-900 mb-4">今日目標</h3>
          <div className="space-y-4">
            <div>
        ...
        <Card className="p-6">
          <h3 className="font-medium text-gray-900 mb-4">效率趨勢</h3>
          <div className="space-y-3">
            <div className="flex justify-between">

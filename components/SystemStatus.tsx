      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className={cn(
            ...
            overallHealth === 'healthy' ? 'bg-reconciliation-approved' : 'bg-reconciliation-pending'
          )} />
...
function ServiceCard({ service }: { service: ServiceHealth }) {
  ...
  return (
    <div className={cn(
      ...
      {/* 錯誤信息 */}
      {service.error && (
        <div className="mt-2 p-2 bg-reconciliation-disputed/10 rounded text-xs text-reconciliation-disputed">
          {service.error}
        </div>
      )}
    </div>

      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link
              href="/login"
              className="hidden h-[44px] items-center rounded-md border border-gray-200 bg-transparent px-4 text-sm font-bold text-gray-900 transition-colors hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 sm:inline-flex dark:border-gray-800 dark:text-gray-100 dark:hover:bg-gray-800"
            >
              登入
            </Link>
            ...
            <Link
              href="/contact"
              className="hidden h-[44px] items-center rounded-md bg-primary-500 px-4 text-sm font-bold text-white transition-colors hover:bg-primary-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 sm:inline-flex dark:focus-visible:ring-offset-gray-900"
            >
              預約 Demo
            </Link>
            ...
            <button
              ...
              className="grid h-[44px] w-[44px] place-items-center rounded-md border border-gray-200 bg-white text-gray-700 transition-colors hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 md:hidden dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              {menuOpen ? (

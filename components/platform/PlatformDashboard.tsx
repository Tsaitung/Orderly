...
const mockPlatformData = {
  ...
  recentAlerts: [
    { id: 1, type: 'warning', message: '供應商「新鮮食材」交貨延遲率異常', time: '3分鐘前', severity: 'medium' },
    { id: 2, type: 'info', message: '本月GMV已達成80%目標', time: '15分鐘前', severity: 'low' },
    { id: 3, type: 'error', message: '對帳差異超過閾值需人工審核', time: '25分鐘前', severity: 'high' },
    { id: 4, type: 'success', message: '系統自動修復網路連線問題', time: '1小時前', severity: 'low' }
  ]
}
...
export function PlatformDashboard() {
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      setData(prev => ({
        ...
        operational: {
          ...prev.operational,
          activeTransactions: prev.operational.activeTransactions + Math.floor(Math.random() * 10 - 5),
          avgResponseTime: Math.max(100, prev.operational.avgResponseTime + Math.floor(Math.random() * 20 - 10))
        }
      }))
      setLastUpdated(new Date())
    }, 30000)
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 核心業務指標 */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">核心業務指標</h3>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-green-600 flex items-center">
                    <TrendingUp className="h-3 w-3 mr-1" />
                    +{data.financial.subscriptionGrowth}%
                  </div>
                </div>
              </div>
        ...
        <div className="xl:col-span-2">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">頂級供應商</h3>
          <Card>
            <CardContent className="p-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {/* 營運狀態 */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-4">營運狀態</h3>

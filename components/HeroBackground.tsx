...
export function HeroBackground() {
  ...
  useEffect(() => {
    // 直接使用備用圖片 URL，確保快速載入
    const fallbackUrl =
      'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1920&h=1080&fit=crop&q=85'
  ...
  return (
    <>
      ...
      {imageSrc && (
        ...
        >
          <div
            className="absolute inset-0 animate-fade-in-scale bg-cover bg-center bg-no-repeat"
            style={{

...
echo ""
echo "Next steps:"
echo "1. Run Alembic migrations for FastAPI services"
echo "   - cd backend/user-service-fastapi && alembic upgrade head && cd -"
echo "   - cd backend/order-service-fastapi && alembic upgrade head && cd -"
echo "   - cd backend/product-service-fastapi && alembic upgrade head && cd -"
echo "2. Start your microservices: npm run dev"

  ...
  'rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-200',
  {
    ...
    compoundVariants: [
      ...
      { variant: 'filled', colorScheme: 'white', class: 'bg-white border-gray-200' },
      {
        variant: 'filled',
        colorScheme: 'primary',
        class: 'bg-primary-50 border-primary-200 text-primary-900',
      },
      {
        variant: 'filled',
        colorScheme: 'restaurant',
        class: 'bg-restaurant-50 border-restaurant-200 text-restaurant-900',
      },
      {
        variant: 'filled',
        colorScheme: 'supplier',
        class: 'bg-supplier-50 border-supplier-200 text-supplier-900',
      },
      {
        variant: 'filled',
        colorScheme: 'platform',
        class: 'bg-platform-50 border-platform-200 text-platform-900',
      },
      ...
      { variant: 'outlined', colorScheme: 'white', class: 'border-gray-300 hover:border-gray-400' },
      {
        variant: 'outlined',
        colorScheme: 'primary',
        class: 'border-primary-300 hover:border-primary-400 hover:bg-primary-50',
      },
      {
        variant: 'outlined',
        colorScheme: 'restaurant',
        class: 'border-restaurant-300 hover:border-restaurant-400 hover:bg-restaurant-50',
      },
      {
        variant: 'outlined',
        colorScheme: 'supplier',
        class: 'border-supplier-300 hover:border-supplier-400 hover:bg-supplier-50',
      },
      {
        variant: 'outlined',
        colorScheme: 'platform',
        class: 'border-platform-300 hover:border-platform-400 hover:bg-platform-50',
      },
      {
        variant: 'outlined',
        colorScheme: 'gray',
        class: 'border-gray-300 hover:border-gray-400 hover:bg-gray-50',
      },
      ...
      { variant: 'glass', colorScheme: 'white', class: 'bg-white/80 border-white/20' },
      {
        variant: 'glass',
        colorScheme: 'primary',
        class: 'bg-primary-100/80 border-primary-200/20 text-primary-900',
      },
      {
        variant: 'glass',
        colorScheme: 'restaurant',
        class: 'bg-restaurant-100/80 border-restaurant-200/20 text-restaurant-900',
      },
      {
        variant: 'glass',
        colorScheme: 'supplier',
        class: 'bg-supplier-100/80 border-supplier-200/20 text-supplier-900',
      },
      {
        variant: 'glass',
        colorScheme: 'platform',
        class: 'bg-platform-100/80 border-platform-200/20 text-platform-900',
      },
      {
        variant: 'glass',
        colorScheme: 'gray',
        class: 'bg-gray-100/80 border-gray-200/20 text-gray-900',
      },
      ...
      },
      {
        variant: 'elevated',
        colorScheme: 'gray',
        class: 'bg-gray-50 border-gray-200 text-gray-900',
      },
    ],
    defaultVariants: {
      variant: 'filled',
...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const isLegacyVariant =
      variant && !['filled', 'outlined', 'ghost', 'elevated', 'glass'].includes(variant)

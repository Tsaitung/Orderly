...
export default function CustomerStats() {
  return (
    <div className="space-y-6">
      ...
      {/* 詳細指標 */}
      <Card className="p-6">
        <h3 className="mb-4 font-medium text-gray-900">客戶關係指標</h3>
      ...
      {/* 客戶分群概覽 */}
      <Card className="p-6">
        <h3 className="mb-4 font-medium text-gray-900">客戶分群分布</h3>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
          {customerSegments.map((segment, index) => (
            <div key={index} className={`rounded-lg p-4 ${segment.bgColor} border`}>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className={`font-medium ${segment.color}`}>{segment.segment}</h4>
                  <Badge variant="outline" size="sm">
                    {segment.percentage}%
                  </Badge>
                </div>
                <div className="text-lg font-bold text-gray-900">{segment.count} 位</div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="p-6">
          <h3 className="mb-4 font-medium text-gray-900">本週活動</h3>
        ...
        <Card className="p-6">
          <h3 className="mb-4 font-medium text-gray-900">待處理事項</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
        ...
        <Card className="p-6">
          <h3 className="mb-4 font-medium text-gray-900">本月目標</h3>
          <div className="space-y-4">
            <div>
              ...
              <div className="h-2 w-full rounded-full bg-gray-200">
                <div className="h-2 rounded-full bg-blue-600" style={{ width: '76.7%' }}></div>
              </div>
            </div>
            <div>
              <div className="mb-1 flex justify-between text-sm">
            ...
            <div>
              ...
              <div className="h-2 w-full rounded-full bg-gray-200">
                <div className="h-2 rounded-full bg-purple-600" style={{ width: '97%' }}></div>
              </div>
            </div>
          </div>
        </Card>

...
import { Users, TrendingUp, Target, Award, AlertTriangle, Eye, BarChart3 } from 'lucide-react'
        ...
        <div className="space-y-6">
          ...
          <Card className="border-blue-200 bg-blue-50 p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="mb-2 font-medium text-blue-900">RFM分析說明</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        <div className={`rounded-lg p-2 ${segment.bgColor}`}>
                          <segment.icon className={`h-5 w-5 ${segment.color}`} />
                        </div>
                        <div>
                          <h3 className="font-semibold text-gray-900">{segment.name}</h3>
                          <p className="text-sm text-gray-600">
                            {segment.count} 位客戶 ({segment.percentage}%)
                          </p>
                        </div>
                      </div>
                    ...
                    {/* 客戶特徵 */}
                    <div>
                      <h4 className="mb-2 text-sm font-medium text-gray-700">客戶特徵</h4>
                    ...
                    {isSelected && (
                      <div className="space-y-3 border-t pt-3">
                        <div>
                          <h4 className="mb-2 text-sm font-medium text-gray-700">分群描述</h4>
                          <p className="text-sm text-gray-600">{segment.description}</p>
                        </div>

                        <div>
                          <h4 className="mb-2 text-sm font-medium text-gray-700">營銷策略</h4>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-purple-200 bg-purple-50 p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="mb-2 font-medium text-purple-900">客戶價值矩陣</h3>
          ...
          <Card className="p-6">
            <div className="grid h-96 grid-cols-2 gap-4">
              {valueMatrix.map((quadrant, index) => (
                <div
                  key={index}
                  className={`rounded-lg p-6 ${quadrant.color} flex flex-col justify-center space-y-4`}
                >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <Card className="p-6">
              <h3 className="mb-4 font-medium text-gray-900">象限策略建議</h3>
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-3">
                  <div className="mt-1 h-3 w-3 rounded-full bg-gray-500"></div>
                  <div>
            ...
            <Card className="p-6">
              <h3 className="mb-4 font-medium text-gray-900">收入貢獻度</h3>
              <div className="space-y-4">
                {valueMatrix.map((quadrant, index) => {

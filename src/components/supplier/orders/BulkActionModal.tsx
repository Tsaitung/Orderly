...
const BULK_ACTIONS: Record<
  Exclude<OrderStatus, 'pending' | 'ready' | 'shipped' | 'accepted' | 'completed' | 'resolved'>,
      ...
      <div className="space-y-6">
              ...
              return (
                ...
                >
                  <div className="flex items-start space-x-3">
                    {Icon && <Icon className="mt-0.5 h-5 w-5 text-gray-700" />}
                    <div>
                      <h4
        ...
        <div>
          ...
          <Textarea
            ...
            className="w-full"
          />
          <p className="mt-1 text-xs text-gray-500">此備註將會記錄在所有被操作訂單的狀態歷史中</p>
        </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-yellow-800">
                  ...
                  <span className="font-medium">
                    {BULK_ACTIONS[selectedStatus! as keyof typeof BULK_ACTIONS].label}
                  </span>
        ...
        <div className="flex justify-end space-x-3 border-t pt-4">
          ...
          <Button onClick={handleSubmit} disabled={!selectedStatus || isUpdating}>
            {isUpdating ? (
              <>

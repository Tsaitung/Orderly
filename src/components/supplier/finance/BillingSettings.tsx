...
const availablePlans: SubscriptionPlan[] = [
  {
    ...
    annualPrice: 0,
    tierLevel: 1,
    features: ['最多 50 個產品', '基本訂單管理', '客戶聯絡功能', '基礎報表', '電子郵件客服'],
    restrictions: {
      maxProducts: 50,
      maxOrders: 100,
      maxLocations: 1,
    ...
    <div className="mx-auto max-w-6xl space-y-8 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">管理您的訂閱方案、付款方式與帳務偏好</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <CardHeader className="text-center">
                  <div className="mb-2 flex justify-center">{getPlanIcon(plan.tierLevel)}</div>
                ...
                <CardContent className="space-y-4">
                  <div className="text-center">
                    {billingCycle === 'monthly' ? (
                      <div>
                        ...
                        {plan.monthlyPrice > 0 && <span className="text-gray-600">/月</span>}
                      </div>
                    ) : (
                      <div>
                        <span className="text-3xl font-bold text-gray-900">
                          {plan.annualPrice === 0
                            ? '免費'
                            : `NT$ ${plan.annualPrice.toLocaleString()}`}
                        </span>
                        {plan.annualPrice > 0 && (
                          <>
                  ...
                  >
                    {isCurrentPlan
                      ? '目前方案'
                      : plan.tierLevel > billingSettings.currentPlan.tierLevel
                        ? '升級'
                        : '降級'}
                  </Button>
                </CardContent>

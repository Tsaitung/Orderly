...
import type { FilterOptions, SortOptions, HierarchyNodeType, ActivityMetrics } from '../../../types'
    ...
    <div className={cn('space-y-6', className)}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-4">
              ...
              return (
                <div key={option.value} className="flex items-center space-x-2">
                  ...
                  <Label
                    ...
                    className="flex cursor-pointer items-center text-sm text-gray-600"
                  >
            ...
            {ACTIVITY_LEVEL_OPTIONS.map(option => {
              ...
              return (
                <div key={option.value} className="flex items-center space-x-2">
                  ...
                  >
                    <Badge className={cn('mr-2 text-xs', option.color)}>{option.label}</Badge>
                  </Label>
                </div>
              )
            })}
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div>
              <Label htmlFor="min-revenue" className="text-xs text-gray-500">
                最低金額
              </Label>
              <Input
                id="min-revenue"
            ...
            <div>
              <Label htmlFor="max-revenue" className="text-xs text-gray-500">
                最高金額
              </Label>
              <Input
                id="max-revenue"
      ...
      <div className="flex flex-col gap-4 border-t border-gray-200 pt-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="include-inactive" className="cursor-pointer text-sm text-gray-600">
            包含停用的客戶
          </Label>
        </div>

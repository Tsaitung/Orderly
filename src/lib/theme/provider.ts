...
export const theme: ThemeConfig = {
  ...
  components: {
    Button: {
      variants: {
        solid:
          'font-medium shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
        outline:
          'font-medium border border-current bg-transparent shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
        ghost:
          'font-medium bg-transparent shadow-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
        subtle:
          'font-medium shadow-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
      },
      colorSchemes: {
        primary: {
          solid: 'bg-primary-500 text-white hover:bg-primary-600 focus-visible:outline-primary-500',
          outline:
            'text-primary-600 border-primary-500 hover:bg-primary-50 focus-visible:outline-primary-500',
          ghost: 'text-primary-600 hover:bg-primary-100 focus-visible:outline-primary-500',
          subtle:
            'bg-primary-100 text-primary-800 hover:bg-primary-200 focus-visible:outline-primary-500',
        },
        restaurant: {
          solid:
            'bg-restaurant-500 text-white hover:bg-restaurant-600 focus-visible:outline-restaurant-500',
          outline:
            'text-restaurant-600 border-restaurant-500 hover:bg-restaurant-50 focus-visible:outline-restaurant-500',
          ghost: 'text-restaurant-600 hover:bg-restaurant-100 focus-visible:outline-restaurant-500',
          subtle:
            'bg-restaurant-100 text-restaurant-800 hover:bg-restaurant-200 focus-visible:outline-restaurant-500',
        },
        supplier: {
          solid:
            'bg-supplier-500 text-white hover:bg-supplier-600 focus-visible:outline-supplier-500',
          outline:
            'text-supplier-600 border-supplier-500 hover:bg-supplier-50 focus-visible:outline-supplier-500',
          ghost: 'text-supplier-600 hover:bg-supplier-100 focus-visible:outline-supplier-500',
          subtle:
            'bg-supplier-100 text-supplier-800 hover:bg-supplier-200 focus-visible:outline-supplier-500',
        },
        platform: {
          solid:
            'bg-platform-500 text-white hover:bg-platform-600 focus-visible:outline-platform-500',
          outline:
            'text-platform-600 border-platform-500 hover:bg-platform-50 focus-visible:outline-platform-500',
          ghost: 'text-platform-600 hover:bg-platform-100 focus-visible:outline-platform-500',
          subtle:
            'bg-platform-100 text-platform-800 hover:bg-platform-200 focus-visible:outline-platform-500',
        },
        gray: {
        ...
        green: {
          ...
          outline:
            'text-green-600 border-green-500 hover:bg-green-50 focus-visible:outline-green-500',
        ...
        yellow: {
          ...
          outline:
            'text-yellow-600 border-yellow-500 hover:bg-yellow-50 focus-visible:outline-yellow-500',
          ghost: 'text-yellow-600 hover:bg-yellow-100 focus-visible:outline-yellow-500',
          subtle:
            'bg-yellow-100 text-yellow-800 hover:bg-yellow-200 focus-visible:outline-yellow-500',
        },
      },
      sizes: {
        sm: 'h-8 px-3 text-sm',

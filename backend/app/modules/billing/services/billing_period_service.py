...
from app.modules.billing.models.reconciliation import BillingPeriod, Reconciliation
from app.modules.billing.models.enums import ReconciliationStatus
from app.modules.billing.schemas.billing_period import BillingPeriodCreate, BillingPeriodUpdate
...
class BillingPeriodService:
    ...
    async def close_billing_period(
        ...
        if create_reconciliation:
            ...
            from app.modules.billing.schemas.reconciliation import ReconciliationCreate

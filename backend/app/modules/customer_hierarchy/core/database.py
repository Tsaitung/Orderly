...
# Use the declarative Base from app.modules.customer_hierarchy.models to keep metadata consistent
from app.modules.customer_hierarchy.models import Base as Base  # re-export for local references
...
async def init_db():
    ...
    from app.modules.customer_hierarchy.models import (
        CustomerGroup,
        CustomerCompany,
        CustomerLocation,
        BusinessUnit,

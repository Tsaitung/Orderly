...
export class SupplierService {
  ...
  async getMetrics(organizationId: string, period?: string): Promise<SupplierDashboardMetrics> {
    ...
    return this.request<SupplierDashboardMetrics>(
      `/api/suppliers/suppliers/${organizationId}/metrics${queryParams}`
    )
  }
  ...
  async getCustomers(
    ...
    if (params.search_query) queryParams.append('search_query', params.search_query)
    if (params.has_recent_orders !== undefined)
      queryParams.append('has_recent_orders', params.has_recent_orders.toString())
  ...
  async updateCustomer(
    ...
    return this.request<SupplierCustomer>(
      `/api/suppliers/suppliers/${organizationId}/customers/${customerId}`,
      {
        method: 'PUT',
        body: JSON.stringify(data),
      }
  ...
  async updateOnboardingStep(
    ...
    return this.request<OnboardingProgress>(
      `/api/suppliers/suppliers/${organizationId}/onboarding/step`,
      {
        method: 'POST',
  ...
  async completeOnboardingStep(
    ...
    return this.request<OnboardingProgress>(
      `/api/suppliers/suppliers/${organizationId}/onboarding/${stepName}/complete`,
      {
        method: 'POST',
      }
    )
  ...
  async submitOnboardingForReview(organizationId: string): Promise<OnboardingProgress> {
    return this.request<OnboardingProgress>(
      `/api/suppliers/suppliers/${organizationId}/onboarding/submit`,
      {
        method: 'POST',
      }
    )
  ...
  async getOrder(organizationId: string, orderId: string): Promise<SupplierOrder> {
    return this.request<SupplierOrder>(
      `/api/suppliers/suppliers/${organizationId}/orders/${orderId}`
    )
  }
  ...
  async updateOrderStatus(
    ...
    return this.request<SupplierOrder>(
      `/api/suppliers/suppliers/${organizationId}/orders/${orderId}/status`,
      {
        method: 'PUT',
  ...
  async bulkUpdateOrderStatus(
    ...
    return this.request<{ updated_count: number; orders: SupplierOrder[] }>(
      `/api/suppliers/suppliers/${organizationId}/orders/bulk-status`,
      {
        method: 'PUT',
  ...
  async bulkUpdateCustomers(
    ...
    return this.request<SupplierCustomer[]>(
      `/api/suppliers/suppliers/${organizationId}/customers/bulk`,
      {
        method: 'PUT',
  ...
  async exportCustomers(organizationId: string, format: 'csv' | 'xlsx' = 'csv'): Promise<Blob> {
    const response = await fetch(
      `${this.baseURL}/api/suppliers/suppliers/${organizationId}/customers/export?format=${format}`,
      {
        headers: this.getAuthHeaders(),
      }
    )

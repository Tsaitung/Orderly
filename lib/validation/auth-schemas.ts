...
export class AuthValidation {
   ...
   */
  static validateRegistration(data: unknown): { success: true; data: RegisterFormData } | { success: false; errors: Record<string, string> } {
    try {
   ...
   */
  static validateMFA(data: unknown): { success: true; data: MFAVerificationData } | { success: false; errors: Record<string, string> } {
    try {

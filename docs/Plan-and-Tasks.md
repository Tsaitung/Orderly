...
- [ ] **T1.1.1** 專案結構初始化
  ...
  - [ ] 建立工作區結構 (frontend, backend, shared)
  - **負責人**: 技術負責人
  - **預計工時**: 8小時
  - **驗收標準**: 專案可正常啟動，代碼格式化正常

- [ ] **T1.1.2** 資料庫設計與初始化
  - [ ] 設計核心資料表結構 (users, companies, orders, products)
  - [ ] 配置 Prisma ORM
  - [ ] 建立資料庫遷移腳本
  - [ ] 設置開發/測試環境資料庫
  - **負責人**: 後端開發
  - **預計工時**: 16小時
  - **驗收標準**: 資料庫結構完整，遷移腳本可正常執行
...
- [ ] **T1.4.2** 基礎組件開發
  - [ ] Button, Input, Select 組件
  - [ ] Modal, Toast, Loading 組件
  - [ ] Navigation, Sidebar 組件
  - [ ] Form validation 組件
  - **負責人**: 前端開發
  - **預計工時**: 24小時

...
> Status: Historical context. For current database operations and migrations, see `docs/0-Design/database.md`.
...
- Updated Docker Compose configs (`compose.*.yml`) to build/run the new FastAPI services.

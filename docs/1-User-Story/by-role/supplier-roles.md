# 供應商端角色 User Story 索引

> 最後更新: 2025-12-16
> 狀態: Active

本文件彙整所有與供應商端角色相關的 User Story 連結索引。

---

## supplier_admin（供應商管理者）

組織完全控制、商品管理、價目管理、用戶管理。

### 身份驗證與用戶管理
- [US-AUTH-002: 供應商完整註冊](../by-module/01-auth-user-management.md#us-auth-002-供應商完整註冊)
...
- [US-BIL-005: 電子發票整合](../by-module/05-billing-settlement.md#us-bil-005-電子發票整合)
- [US-BIL-008: 多幣別和匯率轉換](../by-module/05-billing-settlement.md#us-bil-008-多幣別和匯率轉換)

### 客戶層級
- [US-HIER-005: 公司層級合併帳單](../by-module/06-customer-hierarchy.md#us-hier-005-公司層級合併帳單)

### 導入與推薦
- [US-ONB-002: 供應商完整註冊流程](../by-module/07-onboarding-process.md#us-onb-002-供應商完整註冊流程)
- [US-ONB-006: 產品目錄快速導入](../by-module/07-onboarding-process.md#us-onb-006-產品目錄快速導入)
- [US-ONB-007: 定價策略設定](../by-module/07-onboarding-process.md#us-onb-007-定價策略設定)
- [US-ONB-009: 客戶邀請引導](../by-module/07-onboarding-process.md#us-onb-009-客戶邀請引導)
- [US-REF-002: 供應商邀請餐廳](../by-module/08-referral-system.md#us-ref-002-供應商邀請餐廳)
...
- [US-REF-008: 被推薦者優惠](../by-module/08-referral-system.md#us-ref-008-被推薦者優惠)
...
### 客戶層級
- [US-HIER-004: 查看客戶組織結構](../by-module/06-customer-hierarchy.md#us-hier-004-查看客戶組織結構)

### ERP 整合
- [US-ERP-003: 即時訂單更新](../by-module/09-erp-integration.md#us-erp-003-即時訂單更新)

### 推薦系統
- [US-REF-006: 關係健康度監控](../by-module/08-referral-system.md#us-ref-006-關係健康度監控)
- [US-REF-011: 關係優化建議](../by-module/08-referral-system.md#us-ref-011-關係優化建議)

---

## supplier_operator（供應商操作員）

...
| 模組 | 代表性 User Story |
|------|-----------------|
| AUTH | US-AUTH-001 餐廳快速註冊、US-AUTH-003 標準登入（Line 主/Google 次）、**US-AUTH-022 社群帳號恢復**、**US-AUTH-019 合作邀請分享**、**US-AUTH-021 受邀加入與收藏**、**US-AUTH-016 平台統一登入**、**US-AUTH-017 行動瀏覽器** |
